    ...
    return FutureBuilder(
      ...
      builder: (BuildContext context, AsyncSnapshot<dynamic> snapshot) {
        if (snapshot.connectionState == ConnectionState.done) {
          ...
          return Column(
            children: [
              const Center(child: Text('Total Building activity per day:')),
              Expanded(
                child: BarChart(
                  BarChartData(
...
class BuildingBarChart extends StatefulWidget {
  final int choice;

  const BuildingBarChart({Key? key, required this.choice}) : super(key: key);
  @override
  State<StatefulWidget> createState() => BuildingBarChartState();
}

class BuildingBarChartState extends State<BuildingBarChart> {
  @override
  Widget build(BuildContext context) {
